...
data <- as.data.frame(cbind(station_info$elon, station_info$nlat, dateId))
colnames(data) <- c("stationLon", "stationLat", "date")
...
dir <- './data'
saveRDS(data, file = paste(dir, filename, sep = '/'))
